// Íconos de línea (SVG) minimalistas para la navegación y acciones.
// Un solo componente <Icon name="..." /> para mantener todo liviano.

type IconName =
  | 'home' | 'cart' | 'box' | 'cash' | 'grid' | 'bell' | 'truck' | 'users'
  | 'chart' | 'gear' | 'shield' | 'building' | 'tag' | 'search' | 'plus'
  | 'scan' | 'check' | 'x' | 'arrow-left' | 'trash' | 'edit' | 'minus'
  | 'doc' | 'whatsapp' | 'mail' | 'print' | 'logout' | 'alert' | 'wifi-off'

const paths: Record<IconName, string> = {
  home: 'M3 11l9-8 9 8M5 10v10a1 1 0 001 1h3v-6h6v6h3a1 1 0 001-1V10',
  cart: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 5h14M10 21a1 1 0 100-2 1 1 0 000 2zm8 0a1 1 0 100-2 1 1 0 000 2z',
  box: 'M21 8l-9-5-9 5 9 5 9-5zM3 8v8l9 5 9-5V8M12 13v8',
  cash: 'M2 7h20v10H2zM12 12a2 2 0 100-4 2 2 0 000 4zM6 9v6M18 9v6',
  grid: 'M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z',
  bell: 'M18 8a6 6 0 10-12 0c0 7-3 9-3 9h18s-3-2-3-9M13.7 21a2 2 0 01-3.4 0',
  truck: 'M1 4h15v12H1zM16 8h4l3 3v5h-7M5.5 19a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm12 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z',
  ...
  whatsapp: 'M21 11.5a8.38 8.38 0 01-8.5 8.5 8.5 8.5 0 01-3.8-.9L3 21l1.9-5.7a8.5 8.5 0 1116.1-3.8z',
