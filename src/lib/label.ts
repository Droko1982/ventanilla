...
// Las barras son una representación visual del código; el código escaneable es
// el que ya trae el producto (barras del fabricante) o su código interno.
export function printLabel(product: Product, businessName: string, copies = 1) {
  ...
  const bars = code
    ...
    .map((ch) => {
      ...
      return `<span style="display:inline-block;width:${w}px;height:34px;background:#000;margin-right:1px"></span>`
    })
    .join('')
  ...
  <style>
    *{font-family:Arial, sans-serif; margin:0; padding:0;}
    ...
    .lbl{width:200px; border:1px solid #ccc; border-radius:6px; padding:8px; text-align:center;}
